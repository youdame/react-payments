...
const shinhan = "_shinhan_1cqjg_18";
const kakao = "_kakao_1cqjg_22";
const hyundai = "_hyundai_1cqjg_26";
const woori = "_woori_1cqjg_30";
const lotte = "_lotte_1cqjg_34";
const hana = "_hana_1cqjg_38";
const kookmin = "_kookmin_1cqjg_42";
const numberWrapper = "_numberWrapper_1cqjg_46";
const chipWrapper = "_chipWrapper_1cqjg_52";
const cardLogo = "_cardLogo_1cqjg_58";
const chip = "_chip_1cqjg_52";
...
function getCardColorClass(company) {
  const CARD_INFO = {
    BC카드: "bc",
    신한카드: "shinhan",
    카카오뱅크: "kakao",
...
const getCardBrand = (value) => {
  ...
  return (brand == null ? void 0 : brand.name) ?? null;
};
...
function CardExpirationSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.sectionContainer, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.inputSection, children: [
      ...
      isError && /* @__PURE__ */ jsxRuntimeExports.jsx(InputSection.Error, { message: expiration.month.errorMessage || expiration.year.errorMessage })
    ] })
  ] });
}
...
function CardCompanySection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(InputSection.TitleWrapper, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(InputSection.SubTitle, { title: "현재 국내 카드사만 가능합니다." })
    ] }),
...
function PasswordSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.sectionContainer, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(InputSection.TitleWrapper, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(InputSection.SubTitle, { title: "앞의 2자리를 입력해주세요" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.inputSection, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(InputSection.Label, { text: "비밀번호 앞 2자리" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
      ...
      password.errorMessage && /* @__PURE__ */ jsxRuntimeExports.jsx(InputSection.Error, { message: password.errorMessage })
    ] })
  ] });
}
const button = "_button_154lr_1";
const styles$2 = {
  button
};
function Button({ children, ...props }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("button", { ...props, className: styles$2.button, children });
}
const useStack = (initialStep) => {
  const [step, setStep] = reactExports.useState(initialStep);
  const StackComponent = reactExports.useCallback(
    ({ children }) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: visibleSteps.map((child) => child) });
    },
    [step]
  );
...
function CompletePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.wrapper, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: styles$1.text, children: [
      ...
      (_b = location.state) == null ? void 0 : _b.company,
      "가 등록되었어요."
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleGoToHome, children: "확인" })
  ] });
}
const app = "_app_tyvxe_1";
const styles = {
  app
};
function Layout() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.app, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) });
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Routes, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Route, { element: /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, {}), children: [
...
ReactDOM.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { basename: "/react-payment", children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) })
);
